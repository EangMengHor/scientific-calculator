...
function calculator(button){
    if(button.type == 'operator'){
        ...
        // fix power and factorail
        // search for factorial and power
...
function factorialNumberGetter(formula, FACTORIAL_SEARCH_RESULT){
    ...
    FACTORIAL_SEARCH_RESULT.forEach(factorial_index => {
        ...
        // if there wqas  a factorial sequence we need to get the first index of the very first factorial
        let first_factorial_index = factorial_index - factorial_sequence

        // then get the number right before it
